...
const overviewData = [
	{ name: "Revenu", value: "1 234 567 $", change: 12.5, icon: DollarSign },
	{ name: "Utilisateurs", value: "45 678", change: 8.3, icon: Users },
	{ name: "Commandes", value: "9 876", change: -3.2, icon: ShoppingBag },
	{ name: "Pages vues", value: "1 234 567", change: 15.7, icon: Eye },
];
          ...
          '
            ...
            `}
					>
						...
						<span className='ml-2 text-sm text-gray-400'>par rapport à la période précédente</span>
					</div>
				</motion.div>
			))}
		</div>
